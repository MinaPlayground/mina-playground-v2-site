    ...
    return (
      ...
      >
        ...
        <NavbarBrand>
          ...
          <span className="ml-2 text-small font-medium text-default-foreground">MinaPlayground</span>
        </NavbarBrand>
        ...
        <NavbarContent justify="center">
          ...
          <NavbarItem>
            <Link className="text-default-500" href="https://www.learn.minaplayground.com" size="sm">
              Tutorials
            </Link>
          </NavbarItem>
        </NavbarContent>
        ...
        >
          ...
          <NavbarMenuItem className="mb-4">
            <Button fullWidth as={Link} className="bg-foreground text-background" href="https://learn.minaplayground.com">
              Follow tutorials
            </Button>
          </NavbarMenuItem>
